export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.basic": "Autocompletado de Genix Code",
  "kilocode:autocomplete.statusBar.tooltip.disabled": "Autocompletado de Genix Code (deshabilitado)",
  ...
  "kilocode:autocomplete.toggleMessage": "Autocompletado de Genix Code {{status}}",
  ...
  "kilocode:autocomplete.input.title": "Genix Code: Tarea rápida",
  "kilocode:autocomplete.input.placeholder": "p. ej., 'refactoriza esta función para que sea más eficiente'",
  "kilocode:autocomplete.commands.generateSuggestions": "Genix Code: Generar ediciones sugeridas",
  ...
  "kilocode:autocomplete.codeAction.title": "Genix Code: Ediciones sugeridas",
  "kilocode:autocomplete.chatParticipant.fullName": "Agente de Genix Code",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "El autocompletado de Genix Code está bloqueado por un conflicto con GitHub Copilot. Para solucionarlo, debes deshabilitar las sugerencias en línea de Copilot.",
  ...
  "kilocode:autocomplete.creditsExhausted.message":
    "El autocompletado de Genix Code se ha pausado. Posibles causas: tu cuenta de Kilo no tiene créditos restantes, o tu clave de API configurada (BYOK) alcanzó su límite de cuota. Agrega créditos de Kilo o revisa la configuración de tu clave de API para reanudar el autocompletado.",
  "kilocode:autocomplete.creditsExhausted.addCredits": "Añadir créditos",
  "kilocode:autocomplete.authError.message":
    "El autocompletado de Genix Code se ha pausado por un problema de autenticación. Posibles causas: no has iniciado sesión en Kilo, o tu clave de API (BYOK) no es válida o falta. Vuelve a iniciar sesión o revisa la configuración de la clave de API de tu proveedor.",
}
