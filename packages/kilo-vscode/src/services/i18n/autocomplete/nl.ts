export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.basic": "Genix Code automatisch aanvullen",
  "kilocode:autocomplete.statusBar.tooltip.disabled": "Genix Code automatisch aanvullen (uitgeschakeld)",
  ...
  "kilocode:autocomplete.toggleMessage": "Genix Code automatisch aanvullen {{status}}",
  ...
  "kilocode:autocomplete.input.title": "Genix Code: Snelle taak",
  "kilocode:autocomplete.input.placeholder": "bijv. 'refactor deze functie zodat deze efficiënter is'",
  "kilocode:autocomplete.commands.generateSuggestions": "Genix Code: Voorgestelde bewerkingen genereren",
  ...
  "kilocode:autocomplete.codeAction.title": "Genix Code: Voorgestelde bewerkingen",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "Genix Code automatisch aanvullen wordt geblokkeerd door een conflict met GitHub Copilot. Schakel de inline suggesties van Copilot uit om dit op te lossen.",
  ...
  "kilocode:autocomplete.creditsExhausted.message":
    "Genix Code Autocomplete is gepauzeerd. Mogelijke oorzaken: je Kilo-account heeft geen credits meer, of je geconfigureerde API-sleutel (BYOK) heeft de quotumlimiet bereikt. Voeg Kilo-credits toe of controleer je API-sleutelconfiguratie om autocomplete te hervatten.",
  "kilocode:autocomplete.creditsExhausted.addCredits": "Credits toevoegen",
  "kilocode:autocomplete.authError.message":
    "Genix Code Autocomplete is gepauzeerd vanwege een authenticatieprobleem. Mogelijke oorzaken: je bent niet aangemeld bij Kilo, of je API-sleutel (BYOK) is ongeldig of ontbreekt. Meld je opnieuw aan of controleer de API-sleutelinstellingen van je provider.",
}
