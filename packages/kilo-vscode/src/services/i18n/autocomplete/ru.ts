export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.basic": "Автодополнение Genix Kilo Code",
  "kilocode:autocomplete.statusBar.tooltip.disabled": "Автодополнение Genix Kilo Code (отключено)",
  ...
  "kilocode:autocomplete.toggleMessage": "Автодополнение Genix Kilo Code {{status}}",
  ...
  "kilocode:autocomplete.input.title": "Genix Kilo Code: Быстрая задача",
  "kilocode:autocomplete.input.placeholder": "например: 'отрефакторить эту функцию, чтобы она была эффективнее'",
  "kilocode:autocomplete.commands.generateSuggestions": "Genix Kilo Code: Создать предлагаемые правки",
  ...
  "kilocode:autocomplete.codeAction.title": "Genix Kilo Code: Предлагаемые правки",
  "kilocode:autocomplete.chatParticipant.fullName": "Агент Genix Kilo Code",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "Автодополнение Genix Kilo Code блокируется из-за конфликта с GitHub Copilot. Чтобы исправить это, необходимо отключить встроенные предложения Copilot.",
  ...
  "kilocode:autocomplete.creditsExhausted.message":
    "Автодополнение Genix Kilo Code приостановлено. Возможные причины: на вашем аккаунте Kilo не осталось кредитов или настроенный API-ключ (BYOK) достиг лимита квоты. Добавьте кредиты Kilo или проверьте конфигурацию API-ключа, чтобы возобновить автодополнение.",
  "kilocode:autocomplete.creditsExhausted.addCredits": "Добавить кредиты",
  "kilocode:autocomplete.authError.message":
    "Автодополнение Genix Kilo Code приостановлено из-за проблемы с аутентификацией. Возможные причины: вы не вошли в Kilo или ваш API-ключ (BYOK) недействителен либо отсутствует. Войдите снова или проверьте настройки API-ключа провайдера.",
}
