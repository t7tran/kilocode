...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.basic": "Genix Kilo Code Autocomplete",
  "kilocode:autocomplete.statusBar.tooltip.disabled": "Genix Kilo Code Autocomplete (disabled)",
  ...
  "kilocode:autocomplete.toggleMessage": "Genix Kilo Code Autocomplete {{status}}",
  ...
  "kilocode:autocomplete.input.title": "Genix Kilo Code: Quick Task",
  "kilocode:autocomplete.input.placeholder": "e.g., 'refactor this function to be more efficient'",
  "kilocode:autocomplete.commands.generateSuggestions": "Genix Kilo Code: Generate Suggested Edits",
  ...
  "kilocode:autocomplete.codeAction.title": "Genix Kilo Code: Suggested Edits",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "The Genix Kilo Code Autocomplete is being blocked by a conflict with GitHub Copilot. To fix this, you must disable Copilot's inline suggestions.",
  ...
  "kilocode:autocomplete.creditsExhausted.message":
    "Genix Kilo Code Autocomplete has been paused. Possible causes: your Kilo account has no remaining credits, or your configured API key (BYOK) has reached its quota limit. Add Kilo credits or check your API key configuration to resume autocomplete.",
  "kilocode:autocomplete.creditsExhausted.addCredits": "Add Credits",
  "kilocode:autocomplete.authError.message":
    "Genix Kilo Code Autocomplete has been paused due to an authentication issue. Possible causes: you are not signed in to Kilo, or your API key (BYOK) is invalid or missing. Please sign in again or check your provider API key settings.",
}
