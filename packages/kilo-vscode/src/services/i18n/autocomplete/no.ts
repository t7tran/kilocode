export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.basic": "Genix Kilo Code autofullføring",
  "kilocode:autocomplete.statusBar.tooltip.disabled": "Genix Kilo Code autofullføring (deaktivert)",
  ...
  "kilocode:autocomplete.toggleMessage": "Genix Kilo Code autofullføring {{status}}",
  ...
  "kilocode:autocomplete.input.title": "Genix Kilo Code: Hurtig oppgave",
  "kilocode:autocomplete.input.placeholder": "f.eks. 'refaktorer denne funksjonen så den blir mer effektiv'",
  "kilocode:autocomplete.commands.generateSuggestions": "Genix Kilo Code: Generer foreslåtte redigeringer",
  ...
  "kilocode:autocomplete.codeAction.title": "Genix Kilo Code: Foreslåtte redigeringer",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "Genix Kilo Code autofullføring blokkeres av en konflikt med GitHub Copilot. For å fikse dette må du deaktivere Copilots inline-forslag.",
  ...
  "kilocode:autocomplete.creditsExhausted.message":
    "Genix Kilo Code autofullføring er satt på pause. Mulige årsaker: Kilo-kontoen din har ingen gjenværende kreditter, eller den konfigurerte API-nøkkelen (BYOK) har nådd kvotegrensen. Legg til Kilo-kreditter eller kontroller API-nøkkelkonfigurasjonen for å gjenoppta autofullføring.",
  "kilocode:autocomplete.creditsExhausted.addCredits": "Legg til kreditter",
  "kilocode:autocomplete.authError.message":
    "Genix Kilo Code autofullføring er satt på pause på grunn av et autentiseringsproblem. Mulige årsaker: du er ikke logget på Kilo, eller API-nøkkelen din (BYOK) er ugyldig eller mangler. Logg inn igjen eller kontroller innstillingene for leverandørens API-nøkkel.",
}
