export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.basic": "Genix Kilo Code otomatik tamamlama",
  "kilocode:autocomplete.statusBar.tooltip.disabled": "Genix Kilo Code otomatik tamamlama (devre dışı)",
  ...
  "kilocode:autocomplete.toggleMessage": "Genix Kilo Code otomatik tamamlama {{status}}",
  "kilocode:autocomplete.progress.title": "Genix Kilo Code",
  "kilocode:autocomplete.progress.analyzing": "Kodunuz analiz ediliyor...",
  ...
  "kilocode:autocomplete.input.title": "Genix Kilo Code: Hızlı görev",
  "kilocode:autocomplete.input.placeholder": "örn. 'bu fonksiyonu daha verimli olacak şekilde yeniden düzenle'",
  "kilocode:autocomplete.commands.generateSuggestions": "Genix Kilo Code: Önerilen düzenlemeler oluştur",
  "kilocode:autocomplete.commands.displaySuggestions": "Önerilen düzenlemeleri göster",
  "kilocode:autocomplete.commands.cancelSuggestions": "Önerilen düzenlemeleri iptal et",
  "kilocode:autocomplete.commands.applyCurrentSuggestion": "Geçerli önerilen düzenlemeyi uygula",
  ...
  "kilocode:autocomplete.codeAction.title": "Genix Kilo Code: Önerilen düzenlemeler",
  "kilocode:autocomplete.chatParticipant.fullName": "Genix Kilo Code aracı",
  "kilocode:autocomplete.chatParticipant.name": "Aracı",
  "kilocode:autocomplete.chatParticipant.description":
    "Hızlı görevler ve önerilen düzenlemeler konusunda yardımcı olabilirim.",
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "Genix Kilo Code otomatik tamamlama, GitHub Copilot ile çakışma nedeniyle engelleniyor. Bunu düzeltmek için Copilot'un satır içi önerilerini devre dışı bırakmalısınız.",
  ...
  "kilocode:autocomplete.creditsExhausted.message":
    "Genix Kilo Code otomatik tamamlama duraklatıldı. Olası nedenler: Kilo hesabınızda kalan kredi yok veya yapılandırılmış API anahtarınız (BYOK) kota sınırına ulaştı. Otomatik tamamlamayı sürdürmek için Kilo kredisi ekleyin veya API anahtarı yapılandırmanızı kontrol edin.",
  "kilocode:autocomplete.creditsExhausted.addCredits": "Kredi ekle",
  "kilocode:autocomplete.authError.message":
    "Genix Kilo Code otomatik tamamlama bir kimlik doğrulama sorunu nedeniyle duraklatıldı. Olası nedenler: Kilo'da oturum açmadınız veya API anahtarınız (BYOK) geçersiz ya da eksik. Lütfen tekrar oturum açın veya sağlayıcı API anahtarı ayarlarınızı kontrol edin.",
}
