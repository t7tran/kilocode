export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.basic": "Genix Kilo Code オートコンプリート",
  "kilocode:autocomplete.statusBar.tooltip.disabled": "Genix Kilo Code オートコンプリート (無効)",
  ...
  "kilocode:autocomplete.toggleMessage": "Genix Kilo Code オートコンプリート {{status}}",
  ...
  "kilocode:autocomplete.input.title": "Genix Kilo Code: クイックタスク",
  "kilocode:autocomplete.input.placeholder": "例: 'この関数をより効率的にリファクタリングする'",
  "kilocode:autocomplete.commands.generateSuggestions": "Genix Kilo Code: 提案された編集を生成",
  ...
  "kilocode:autocomplete.codeAction.title": "Genix Kilo Code: 提案された編集",
  "kilocode:autocomplete.chatParticipant.fullName": "Genix Kilo Code エージェント",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "Genix Kilo Code オートコンプリートは GitHub Copilot との競合によりブロックされています。修正するには、Copilot のインライン提案を無効にする必要があります。",
  ...
  "kilocode:autocomplete.creditsExhausted.message":
    "Genix Kilo Code オートコンプリートは一時停止されました。考えられる原因: Kilo アカウントに残りクレジットがない、または設定済みの API キー (BYOK) がクォータ上限に達しています。オートコンプリートを再開するには、Kilo クレジットを追加するか API キー設定を確認してください。",
  "kilocode:autocomplete.creditsExhausted.addCredits": "クレジットを追加",
  "kilocode:autocomplete.authError.message":
    "Genix Kilo Code オートコンプリートは認証の問題により一時停止されました。考えられる原因: Kilo にサインインしていない、または API キー (BYOK) が無効または不足しています。再度サインインするか、プロバイダーの API キー設定を確認してください。",
}
