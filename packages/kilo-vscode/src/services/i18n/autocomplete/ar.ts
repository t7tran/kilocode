export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.basic": "الإكمال التلقائي في Genix Code",
  "kilocode:autocomplete.statusBar.tooltip.disabled": "الإكمال التلقائي في Genix Code (معطل)",
  ...
  "kilocode:autocomplete.toggleMessage": "الإكمال التلقائي في Genix Code {{status}}",
  ...
  "kilocode:autocomplete.input.title": "Genix Code: مهمة سريعة",
  "kilocode:autocomplete.input.placeholder": "مثال: 'أعد هيكلة هذه الدالة لتكون أكثر كفاءة'",
  "kilocode:autocomplete.commands.generateSuggestions": "Genix Code: إنشاء تعديلات مقترحة",
  ...
  "kilocode:autocomplete.codeAction.title": "Genix Code: تعديلات مقترحة",
  "kilocode:autocomplete.chatParticipant.fullName": "وكيل Genix Code",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "يتم حظر الإكمال التلقائي في Genix Code بسبب تعارض مع GitHub Copilot. لإصلاح ذلك، يجب تعطيل اقتراحات Copilot المضمنة.",
  ...
  "kilocode:autocomplete.creditsExhausted.message":
    "تم إيقاف الإكمال التلقائي في Genix Code مؤقتا. الأسباب المحتملة: لا توجد أرصدة متبقية في حساب Kilo الخاص بك، أو أن مفتاح API المكون (BYOK) وصل إلى حد الحصة. أضف أرصدة Kilo أو تحقق من إعدادات مفتاح API لاستئناف الإكمال التلقائي.",
  "kilocode:autocomplete.creditsExhausted.addCredits": "إضافة أرصدة",
  "kilocode:autocomplete.authError.message":
    "تم إيقاف الإكمال التلقائي في Genix Code مؤقتا بسبب مشكلة مصادقة. الأسباب المحتملة: لم تسجل الدخول إلى Kilo، أو أن مفتاح API (BYOK) غير صالح أو مفقود. يرجى تسجيل الدخول مرة أخرى أو التحقق من إعدادات مفتاح API للمزود.",
}
