...
export const dict = {
  ...
  "deviceAuth.title": "Accedi a Genix Code",
  ...
  "profile.action.login": "Accedi con Genix Code",
  ...
  "settings.aboutKiloCode.title": "Informazioni su Genix Code",
  "session.messages.empty": "Avvia una conversazione scrivendo un messaggio qui sotto.",
  "session.messages.welcome":
    "Genix Code è un assistente AI per il coding. Chiedigli di creare feature, correggere bug o spiegare il codebase.",
  ...
  "settings.aboutKiloCode.extensionName": "Estensione Genix Code",
  ...
  "settings.language.description": 'Scegli la lingua dell\'interfaccia Genix Code. "Auto" usa la lingua di VS Code.',
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "Migra le impostazioni da una precedente installazione di Genix Code, incluse API key dei provider e modello predefinito.",
  ...
  "migration.whatsNew.title": "Novità in Genix Code",
