...
export const dict = {
  ...
  "deviceAuth.title": "Entrar no Genix Kilo Code",
  ...
  "profile.action.login": "Entrar com Genix Kilo Code",
  ...
  "settings.aboutKiloCode.title": "Sobre o Genix Kilo Code",

  "session.messages.empty": "Inicie uma conversa digitando uma mensagem abaixo.",
  "session.messages.welcome":
    "Genix Kilo Code é um assistente de programação com IA. Peça para criar funcionalidades, corrigir bugs ou explicar sua base de código.",
  ...
  "settings.aboutKiloCode.extensionName": "Extensão Genix Kilo Code",
  ...
  "settings.language.description":
    'Escolha o idioma da interface do Genix Kilo Code. "Auto" usa o idioma de exibição do VS Code.',
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "Migre as configurações de uma instalação anterior do Genix Kilo Code, incluindo chaves de API de provedor e modelo padrão.",
  ...
  // Screen 1 — What's New
  "migration.whatsNew.title": "O Que Há de Novo no Genix Kilo Code",
