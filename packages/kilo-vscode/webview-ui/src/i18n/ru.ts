...
export const dict = {
  ...
  "deviceAuth.title": "Войти в Genix Kilo Code",
  ...
  "profile.action.login": "Войти через Genix Kilo Code",
  ...
  "settings.aboutKiloCode.title": "О Genix Kilo Code",

  "session.messages.empty": "Начните разговор, введя сообщение ниже.",
  "session.messages.welcome":
    "Genix Kilo Code — это AI-помощник для программирования. Попросите его создать функции, исправить ошибки или объяснить вашу кодовую базу.",
  ...
  "settings.aboutKiloCode.extensionName": "Расширение Genix Kilo Code",
  ...
  "settings.language.description": "Выберите язык интерфейса Genix Kilo Code. «Авто» использует язык отображения VS Code.",
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "Перенос настроек из предыдущей установки Genix Kilo Code, включая API-ключи провайдеров и модель по умолчанию.",
  ...
  // Screen 1 — What's New
  "migration.whatsNew.title": "Что нового в Genix Kilo Code",
