...
export const dict = {
  ...
  "deviceAuth.title": "Logg inn på Genix Code",
  ...
  "profile.action.login": "Logg inn med Genix Code",
  ...
  "settings.aboutKiloCode.title": "Om Genix Code",

  "session.messages.empty": "Start en samtale ved å skrive en melding nedenfor.",
  "session.messages.welcome":
    "Genix Code er en AI-kodingsassistent. Be den om å bygge funksjoner, fikse feil eller forklare kodebasen din.",
  ...
  "settings.aboutKiloCode.extensionName": "Genix Code-utvidelse",
  ...
  "settings.language.description": 'Velg språket for Genix Code-grensesnittet. "Auto" bruker VS Codes visningsspråk.',
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "Migrer innstillinger fra en tidligere installasjon av Genix Code, inkludert API-nøkler for leverandører og standardmodell.",
  ...
  // Screen 1 — What's New
  "migration.whatsNew.title": "Hva er nytt i Genix Code",
