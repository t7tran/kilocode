...
export const dict = {
  ...
  "deviceAuth.title": "Se connecter à Genix Code",
  ...
  "profile.action.login": "Se connecter avec Genix Code",
  ...
  "settings.aboutKiloCode.title": "À propos de Genix Code",

  "session.messages.empty": "Commencez une conversation en tapant un message ci-dessous.",
  "session.messages.welcome":
    "Genix Code est un assistant de programmation IA. Demandez-lui de créer des fonctionnalités, corriger des bugs ou expliquer votre code.",
  ...
  "settings.aboutKiloCode.extensionName": "Extension Genix Code",
  ...
  "settings.language.description":
    "Choisissez la langue de l'interface de Genix Code. \"Auto\" utilise la langue d'affichage de VS Code.",
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "Migrer les paramètres d'une précédente installation de Genix Code, y compris les clés d'API des fournisseurs et le modèle par défaut.",
  ...
  // Screen 1 — What's New
  "migration.whatsNew.title": "Nouveautés de Genix Code",
