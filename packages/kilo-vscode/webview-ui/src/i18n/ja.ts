...
export const dict = {
  ...
  "deviceAuth.title": "Genix Codeにサインイン",
  ...
  "profile.action.login": "Genix Codeでログイン",
  ...
  "settings.aboutKiloCode.title": "Genix Codeについて",

  "session.messages.empty": "下にメッセージを入力して会話を始めましょう。",
  "session.messages.welcome":
    "Genix CodeはAIコーディングアシスタントです。機能の構築、バグの修正、コードベースの説明を依頼できます。",
  ...
  "settings.aboutKiloCode.extensionName": "Genix Code拡張機能",
  ...
  "settings.language.description": "Genix Code UIの言語を選択します。「自動」はVS Codeの表示言語を使用します。",
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "プロバイダーのAPIキーやデフォルトモデルなど、以前にインストールしたGenix Codeから設定を移行します。",
  ...
  // Screen 1 — What's New
  "migration.whatsNew.title": "Genix Codeの新機能",
