...
export const dict = {
  ...
  "deviceAuth.title": "Log ind på Genix Code",
  ...
  "profile.action.login": "Log ind med Genix Code",
  ...
  "session.messages.welcome":
    "Genix Code er en AI-kodningsassistent. Bed den om at bygge funktioner, rette fejl eller forklare din kodebase.",
  ...
  "settings.aboutKiloCode.extensionName": "Genix Code-udvidelse",
  ...
  "settings.language.description": 'Vælg sproget til Genix Code-brugerfladen. "Auto" bruger VS Codes visningssprog.',
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "Migrer indstillinger fra en tidligere installation af Genix Code, herunder udbyder API-nøgler og standardmodel.",
  ...
  // Screen 1 — What's New
  "migration.whatsNew.title": "Nyheder i Genix Code",
