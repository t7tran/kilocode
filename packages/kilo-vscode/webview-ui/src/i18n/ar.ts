...
export const dict = {
  ...
  "deviceAuth.title": "تسجيل الدخول إلى Genix Code",
  ...
  "profile.action.login": "تسجيل الدخول باستخدام Genix Code",
  ...
  "settings.aboutKiloCode.title": "حول Genix Code",

  "session.messages.empty": "ابدأ محادثة بكتابة رسالة أدناه.",
  "session.messages.welcome":
    "Genix Code هو مساعد ترميز بالذكاء الاصطناعي. اطلب منه بناء ميزات أو إصلاح أخطاء أو شرح قاعدة الشيفرة.",
  ...
  "settings.aboutKiloCode.extensionName": "إضافة Genix Code",
  ...
  "settings.language.description": 'اختر اللغة لواجهة Genix Code. "تلقائي" يستخدم لغة عرض VS Code.',
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "ترحيل الإعدادات من تثبيت سابق لـ Genix Code، بما في ذلك مفاتيح API لمقدمي الخدمة والنموذج الافتراضي.",
  ...
  // Screen 1 — What's New
  "migration.whatsNew.title": "ما الجديد في Genix Code",
