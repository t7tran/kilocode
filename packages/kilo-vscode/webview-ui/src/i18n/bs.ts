...
export const dict = {
  ...
  "deviceAuth.title": "Prijavite se u Genix Code",
  ...
  "profile.action.login": "Prijavite se putem Genix Code",
  ...
  "settings.aboutKiloCode.title": "O Genix Code-u",

  "session.messages.empty": "Započnite razgovor unosom poruke ispod.",
  "session.messages.welcome":
    "Genix Code je AI asistent za programiranje. Zatražite da gradi funkcionalnosti, ispravlja greške ili objasni vašu bazu koda.",
  ...
  "settings.aboutKiloCode.extensionName": "Genix Code ekstenzija",
  ...
  "settings.language.description": 'Odaberite jezik za Genix Code sučelje. "Auto" koristi jezik prikaza VS Code-a.',
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "Migrirajte postavke iz prethodne instalacije Genix Code, uključujući API ključeve provajdera i podrazumijevani model.",
  ...
  // Screen 1 — What's New
  "migration.whatsNew.title": "Šta je novo u Genix Code",
