...
export const dict = {
  ...
  "deviceAuth.title": "Zaloguj się do Genix Kilo Code",
  ...
  "profile.action.login": "Zaloguj się przez Genix Kilo Code",
  ...
  "settings.aboutKiloCode.title": "O Genix Kilo Code",

  "session.messages.empty": "Rozpocznij rozmowę, wpisując wiadomość poniżej.",
  "session.messages.welcome":
    "Genix Kilo Code to asystent programowania AI. Poproś go o tworzenie funkcji, naprawę błędów lub wyjaśnienie bazy kodu.",
  ...
  "settings.aboutKiloCode.extensionName": "Rozszerzenie Genix Kilo Code",
  ...
  "settings.language.description": 'Wybierz język interfejsu Genix Kilo Code. „Auto" używa języka wyświetlania VS Code.',
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "Migruj ustawienia z poprzedniej instalacji Genix Kilo Code, w tym klucze API dostawców i domyślny model.",
  ...
  // Screen 1 — What's New
  "migration.whatsNew.title": "Co nowego w Genix Kilo Code",
