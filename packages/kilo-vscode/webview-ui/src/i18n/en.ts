...
export const dict = {
  ...
  "deviceAuth.title": "Sign in to Genix Code",
  ...
  "profile.action.login": "Login with Genix Code",
  ...
  "settings.aboutKiloCode.title": "About Genix Code",

  "session.messages.empty": "Start a conversation by typing a message below.",
  "session.messages.welcome":
    "Genix Code is an AI coding assistant. Ask it to build features, fix bugs, or explain your codebase.",
  ...
  "settings.aboutKiloCode.extensionName": "Genix Code Extension",
  ...
  "settings.language.description":
    'Choose the language for the Genix Code UI. "Auto" uses your VS Code display language.',
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "Migrate settings from a previous installation of Genix Code, including provider API keys and default model.",
  ...
  // Screen 1 — What's New
  "migration.whatsNew.title": "What's New in Genix Code",
