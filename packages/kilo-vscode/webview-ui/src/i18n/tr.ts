...
export const dict = {
  ...
  "deviceAuth.title": "Genix Kilo Code'a giriş yap",
  ...
  "profile.action.login": "Genix Kilo Code ile giriş yap",
  ...
  "settings.aboutKiloCode.title": "Genix Kilo Code Hakkında",

  "session.messages.empty": "Aşağıya bir mesaj yazarak sohbete başlayın.",
  "session.messages.welcome":
    "Genix Kilo Code bir yapay zeka kodlama asistanıdır. Özellik geliştirmesini, hata düzeltmesini veya kod tabanınızı açıklamasını isteyin.",
  ...
  "settings.aboutKiloCode.extensionName": "Genix Kilo Code Uzantısı",
  ...
  "settings.language.description":
    '"Otomatik" VS Code görüntüleme dilinizi kullanır. Genix Kilo Code arayüzü için dil seçin.',
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "Sağlayıcı API anahtarları ve varsayılan model dahil olmak üzere Genix Kilo Code'un önceki yüklemesinden ayarları taşıyın.",
  ...
  // Screen 1 — What's New
  "migration.whatsNew.title": "Genix Kilo Code'daki Yenilikler",
