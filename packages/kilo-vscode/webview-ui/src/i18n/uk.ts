...
export const dict = {
  ...
  "deviceAuth.title": "Увійти до Genix Kilo Code",
  ...
  "profile.action.login": "Увійти через Genix Kilo Code",
  ...
  "settings.aboutKiloCode.title": "Про Genix Kilo Code",

  "session.messages.empty": "Напишіть повідомлення нижче, щоб розпочати чат.",
  "session.messages.welcome":
    "Genix Kilo Code — це асистент з кодування на базі ШІ. Попросіть його розробити функцію, виправити помилку або пояснити вашу кодову базу.",
  ...
  "settings.aboutKiloCode.extensionName": "Розширення Genix Kilo Code",
  ...
  "settings.language.description":
    '"Автоматично" використовує мову відображення VS Code. Виберіть мову для інтерфейсу Genix Kilo Code.',
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "Перенести налаштування з попередньої версії Genix Kilo Code, включаючи API-ключі провайдерів та стандартну модель.",
  ...
  // Screen 1 — What's New
  "migration.whatsNew.title": "Що нового в Genix Kilo Code",
