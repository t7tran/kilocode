...
export function lockedProviderID(): ProviderID {
  return ProviderID.make(PROVIDER_ID)
}
...
export function lockedConfigProvider(): ConfigProvider.Info {
...
export function lockedConfigEntry(): [string, ConfigProvider.Info] {
